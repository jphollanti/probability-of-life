  ...
  <main>
    ...
    <section class="card">
      ...
      <ParameterSlider
        ...
        info={'This parameter relates to <a href="https://en.wikipedia.org/wiki/Technosignature" target="_blank" rel="noopener">technosignatures</a> — any detectable sign of technology, past or present. Technosignatures are arguably our best bet for finding extraterrestrial civilizations because they do not require proximity or direct contact; they can be detected across vast interstellar distances using instruments we already possess.' +
        '<br><br><strong>Why radio is special.</strong> From pure physics, <a href="https://en.wikipedia.org/wiki/Radio_wave" target="_blank" rel="noopener">radio waves</a> are uniquely suited for interstellar communication. They travel at the speed of light — the fastest possible speed — and unlike visible light, radio frequencies pass through interstellar dust, gas, and planetary atmospheres with minimal absorption or scattering. A radio signal requires relatively modest energy to produce, yet can be detected across thousands of light-years with a large enough antenna. The <a href="https://en.wikipedia.org/wiki/Water_hole_(radio)" target="_blank" rel="noopener">"water hole"</a> — the quiet band between the hydrogen line (1420\u00A0MHz) and the hydroxyl line (1662\u00A0MHz) — sits in a region of the spectrum with exceptionally low natural background noise, making it a natural <a href="https://en.wikipedia.org/wiki/Focal_point_(game_theory)" target="_blank" rel="noopener">Schelling point</a> where both sender and receiver might independently choose to listen. Because <a href="https://en.wikipedia.org/wiki/Maxwell%27s_equations" target="_blank" rel="noopener">Maxwell\'s equations</a> are universal, any civilization that investigates electromagnetism will discover radio — it is not a cultural accident but a consequence of fundamental physics.' +
        '<br><br><strong>Beyond radio.</strong> Other promising technosignatures include <a href="https://en.wikipedia.org/wiki/Optical_SETI" target="_blank" rel="noopener">laser pulses</a> (which can pack enormous power into narrow beams), atmospheric pollution (industrial gases like CFCs that have no natural source), <a href="https://en.wikipedia.org/wiki/Dyson_sphere" target="_blank" rel="noopener">megastructures</a> that alter a star\'s light curve, and excess infrared radiation from waste heat of advanced energy use.' +
        '<br><br><strong>Why the fraction might be high.</strong> Even civilizations that do not intentionally broadcast will likely leak detectable emissions. On Earth, military radar, television carriers, and other transmissions create an unintentional radio signature. Any species that harnesses electricity and electromagnetism will almost inevitably produce radio-frequency leakage. The discovery of radio is a straightforward consequence of exploring the electromagnetic spectrum.' +
        '<br><br><strong>Why the fraction might be low.</strong> Civilizations may transition to low-leakage technologies such as fiber optics, tight-beam communications, or quantum-encrypted channels that are invisible to distant observers. Some may deliberately avoid broadcasting — the "<a href="https://en.wikipedia.org/wiki/Dark_forest_hypothesis" target="_blank" rel="noopener">dark forest</a>" hypothesis suggests civilizations stay silent out of self-preservation. Others may develop along entirely non-technological paths, or use communication modalities we cannot yet conceive. <a href="https://en.wikipedia.org/wiki/Search_for_extraterrestrial_intelligence" target="_blank" rel="noopener">SETI</a> continues to search for all such signals, but the fraction of civilizations that remain detectable for a significant duration remains one of the deepest open questions in astrobiology.'}
      />

      <ParameterSlider
        bind:value={civilizationSurvival}
        min={1} max={10_000_000_000}
        unit="years"
